                        ...
                        <div className="pickup-box">
                          ...
                          <div className="product-info">
                            <ul className="product-info-list product-info-list-2">
                              ...
                              <li>
                                SKU :{" "}
                                <a href="javascript:void(0)">SDFVW65467</a>
                              </li>
                              <li>
                                MFG :{" "}
                                <a href="javascript:void(0)">Jun 4, 2022</a>
                              </li>
                              <li>
                                Stock :{" "}
                      ...
                      > <div className="tab-pane fade show active" id="description" role="tabpanel"
                        ...
                        <div className="desh-title">
                          ...
                          <p>
                            ...
                            gummi bears. Chocolate cake tart cupcake donut
                            topping liquorice sugar plum chocolate bar. Jelly
                            beans tiramisu caramels jujubes biscuit liquorice
                            chocolate. Pudding toffee jujubes oat cake sweet
                            roll. Lemon drops dessert croissant danish cake
                            cupcake. Sweet roll candy chocolate toffee jelly
                            sweet roll halvah brownie topping. Marshmallow
                            powder candy sesame snaps jelly beans candy canes
                        ...
                        <div className="nav-desh">
                          ...
                          <p>
                            ...
                            jelly-o halvah apple pie pudding gingerbread. Apple
                            pie halvah cake tiramisu shortbread cotton candy
                            croissant chocolate cake. Tart cupcake caramels
                            gummi bears macaroon gingerbread fruitcake marzipan
                            wafer. Marzipan dessert cupcake ice cream tootsie
                            roll. Brownie chocolate cake pudding cake powder
                            candy ice cream ice cream cake. Jujubes soufflé
                            chupa chups cake candy halvah donut. Tart tart icing
                            lemon drops fruitcake apple pie.
                          </p>
                          ...
                          <p>
                            ...
                            halvah. Gummi bears cookie ice cream jelly-o jujubes
                            sweet croissant. Marzipan cotton candy gummi bears
                            lemon drops lollipop lollipop chocolate. Ice cream
                            cookie dragée cake sweet roll sweet roll.Lemon drops
                            cookie muffin carrot cake chocolate marzipan
                            gingerbread topping chocolate bar. Soufflé tiramisu
                  ...
                  <div className="category-menu">
                    ...
                    {tranding_product.map((tranding_product) => {
                      return (
                        <>
                          <ul
                            key={tranding_product.id}
                            className="product-list product-right-sidebar border-0 p-0"
                          >
                            <li>
