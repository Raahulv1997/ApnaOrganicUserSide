...
const onSubmitClick = () =>{
  const { from } = state || {};
  axios.post(`http://192.168.29.108:5000/vendor_login`,credentailval)
  .then(response => {
...
const forgotPassword=()=>{
  axios.post(`http://192.168.29.108:5000/vendor_forgot_password`,{
    email:`${forgotemail}`
  }).then(response => {
...
const onImgView = () =>{
  if(vendorid === null || vendorid === 'undefined' || vendorid === 'null' || vendorid === undefined){
  }
  else{
    axios
...
{/* LOGIN */}
             ...
             {/* <form className="row g-4" onSubmit={undefined}> */}
               ...
               <div className="col-12">
                 <div className="forgot-box my-3">
                   ...
                   <div onClick={()=>setforgotpage(true)}  className="forgotemail_password_btn">
                     Forgot Password? 
                   </div>
                 </div>
               </div>
           ...
           <div className="sign-up-box">
             ...
             <button onClick={()=>setloginpage(false)} className='btn btn-success my-1'>Sign Up</button>
           </div>
         </div>
        //  LOGIN END
         : 
...
<div className="d-flex align-items-center justify-content-center h-100">
  <div className="log-in-box">
    ...
    <div className="input-box">
      <form className="row g-4"  onSubmit={otp === 0 ? forgotPassword : VerifyfORGOTOTP}>
        <div className="col-12">
          <div className="form-floating theme-form-floating log-in-form">
            <input
              type="email"
              ...
              onChange={(e) => handlefORGOTFormChange(e)} value={forgotemail} name={'email'}
            />
    ...
    {/* {otp === 0 ? ( */}
      ...
      {/* ) : null} */}
        <div className="col-12 mt-3">
          <button
            className="btn btn-animation w-100"
            type="button" onClick={VerifyfORGOTOTP}
          >
            Change Password
          </button>
        </div>
